    ...
    <div className="h-44">
      <ResponsiveContainer width="100%" height="100%">
        <BarChart data={data} barGap={4} barSize={18}>
          ...
          />
          <YAxis hide />
          <Tooltip content={<CustomTooltip />} cursor={{ fill: 'rgba(91,127,255,0.06)', radius: 6 }} />
          <Bar dataKey="reviews" name="Reviews" fill="#5B7FFF" radius={[4, 4, 0, 0]} opacity={0.85} />
          <Bar dataKey="newTopics" name="New" fill="#33D9B2" radius={[4, 4, 0, 0]} opacity={0.85} />
        </BarChart>
      </ResponsiveContainer>
    </div>
  );
